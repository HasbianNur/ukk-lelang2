            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container mx-auto">
                                ...
                                @foreach ($lots as $lot)
                                    <div class="flex flex-col justify-between m-5 p-3 rounded-md shadow-md">
                                        ...
                                        <div class="flex flex-col ml-2 mt-2">
                                            <div class="flex">
                                                <svg class="w-4 mr-1" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="flex flex-row">
                                                ...
                                                <unique-bids :lot="{{ $lot->id }}" :bid="{{ $lot->start_price }}"
                                                    :unique="{{ $lot->number_of_unique_bids }}"></unique-bids>
                                            </div>
                                            <div class="flex">
                                                <svg class="w-4 mr-1" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <new-bid :lot="{{ $lot->id }}" :bid="{{ $lot->start_price }}">
                                                </new-bid>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>{{ $lots->links() }}</div>
                    @else
                        <div>Belum Ada Lelang Terbaru</div>
                        @endif
                    </div>
                </div>
            </div>
